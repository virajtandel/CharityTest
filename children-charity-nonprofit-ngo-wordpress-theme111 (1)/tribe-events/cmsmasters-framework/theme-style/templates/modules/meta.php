...
function children_charity_event_meta_info_col_num() {
	$col_num = 1;
...
$cmsmasters_event_meta_info_col = 'cmsmasters_event_meta_info_col_' . children_charity_event_meta_info_col_num();
