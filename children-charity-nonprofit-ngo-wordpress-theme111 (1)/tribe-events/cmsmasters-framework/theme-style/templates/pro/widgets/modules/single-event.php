				...
				<div class="cmsmasters_widget_event_venue_loc">
					<?php if ( isset( $organizer ) && $organizer && ! empty( $organizer_ids ) ): ?>
						<span class="tribe-events-organizer">
							...
							$and = _x( 'and', 'list separator for final two elements', 'children-charity' );
							if ( 1 == count( $organizer_links ) ) {
								echo children_charity_return_content($organizer_links[0]);
							}// end if
							elseif ( 2 == count( $organizer_links ) ) {
								echo children_charity_return_content($organizer_links[0] . ' ' . esc_html( $and ) . ' ' . $organizer_links[1]);
							}// end elseif
							else {
								...
								echo esc_html( ', ' . $and . ' ' );
								echo children_charity_return_content($last_organizer);
							}// end else
							?>
						</span>
					<?php endif ?>
